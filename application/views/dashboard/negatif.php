...
$alumni = $connection->get("search/tweets", ['exclude_replies' => true, 'q' => 'unpad', 'tweet_mode' => 'extended']);
...
//Get Trending Unpad
$trend_alumni = $connection->get("search/tweets", ['exclude_replies' => true, 'q' => '#unpad', 'tweet_mode' => 'extended']);
